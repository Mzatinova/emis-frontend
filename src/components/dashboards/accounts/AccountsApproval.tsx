...
const AccountsApproval: React.FC = () => {
    ...
    const { invoices, approveInvoice, rejectInvoice, fetchInvoices } = useRegistration();
    ...
    return (
        <div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
                ...
                <Table headers={['Select', 'Student', 'Reg No', 'Program', 'Level', 'Amount', 'Payment Verified', 'Status']} rowCount={filteredInvoices.length}>
